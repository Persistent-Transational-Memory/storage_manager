...
#pragma once
#ifndef PTM_MEM_ALLOCATOR_RING_ROUND_ALLOCATOR_DRAM_ALLOCATOR_H
#define PTM_MEM_ALLOCATOR_RING_ROUND_ALLOCATOR_DRAM_ALLOCATOR_H
...
namespace allocator {
	...
	public:
		RindRoundDRAMAllocator(size_t tuple_size, size_t expected_amount):
			...
			global_logger.info("DRAM Map File Path: ", pmem_descriptor_.file_path);
			global_logger.info("DRAM Map Size: ", pmem_descriptor_.total_size);
		}
...
#endif //PTM_MEM_ALLOCATOR_RING_ROUND_ALLOCATOR_DRAM_ALLOCATOR_H
