...
#pragma once
#ifndef PTM_DATA_MANAGER_SIMPLE_DATA_MANAGER_PMEM_DATA_MANAGER_H
#define PTM_DATA_MANAGER_SIMPLE_DATA_MANAGER_PMEM_DATA_MANAGER_H
...
namespace datam {
	...
	template<class Key, class TupleHeader, class IndexTuple, IndexType IndexTp>
	struct PMEMNUMADataManagerBasic {
		using DataAllocator = allocator::SimpleNUMALocalPmemAllocator;
	...
	template<class Key, class TupleHeader, class IndexTuple, IndexType IndexTp>
	class PMEMNUMADataManager  : public SimpleDataManagerTemplate<
			Key, TupleHeader,
			IndexTuple,
			typename PMEMNUMADataManagerBasic<Key, TupleHeader, IndexTuple, IndexTp>::DataIndex,
			typename PMEMNUMADataManagerBasic<Key, TupleHeader, IndexTuple, IndexTp>::DataAllocator
	>  {
	public:
		using BaseType = SimpleDataManagerTemplate<
				Key, TupleHeader,
		...
		PMEMNUMADataManager(size_t tuple_size, size_t expected_amount): BaseType(tuple_size, expected_amount) {}

	};

}

#endif //PTM_DATA_MANAGER_SIMPLE_DATA_MANAGER_PMEM_DATA_MANAGER_H
