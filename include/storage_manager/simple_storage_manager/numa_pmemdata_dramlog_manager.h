...
#pragma once
#ifndef PTM_STORAGE_MANAGER_SIMPLE_STORAGE_MANAGER_NUMA_PMEM_DATA_DRAM_LOG_MANGER_H
#define PTM_STORAGE_MANAGER_SIMPLE_STORAGE_MANAGER_NUMA_PMEM_DATA_DRAM_LOG_MANGER_H
...
namespace storage {
	...
	class PDDLNUMAManager:
			public SimpleMVStorageManagerTemplate<
					typename datam::DataManagerManager<datam::DataManagerKind::PMEM_NUMA, DataKey, TupleHeader, IndexTuple, DataIndexTp>::DataManager ,
					logm::LogManagerManager<logm::LogManagerKind::DRAM_TL>::LogManager,
					typename versionm::VersionManagerManager<versionm::VersionManagerKind::PMEM_NUMA, VersionHeader>::VersionManager
			> {

	public:
		using Self             = PDDLNUMAManager<DataKey, TupleHeader, IndexTuple, DataIndexTp, VersionHeader>;
		using DataManager      = datam::DataManagerManager<datam::DataManagerKind::PMEM_NUMA, DataKey, TupleHeader, IndexTuple, DataIndexTp>::DataManager;
	...
	template<typename DataKey,
			...
			IndexType DataIndexTp>
	requires DataKeyTypeConcept<DataKey>
	class PDDLNUMAManager<DataKey, TupleHeader, IndexTuple, DataIndexTp, void>:
	...
	public:
		using Self             = PDDLNUMAManager<DataKey, TupleHeader, IndexTuple, DataIndexTp, void>;
		using DataManager      = datam::DataManagerManager<datam::DataManagerKind::PMEM_NUMA, DataKey, TupleHeader, IndexTuple, DataIndexTp>::DataManager;
		using LogManager       = logm::LogManagerManager<logm::LogManagerKind::DRAM_TL>::LogManager;
...
#endif //PTM_STORAGE_MANAGER_SIMPLE_STORAGE_MANAGER_NUMA_PMEM_DATA_DRAM_LOG_MANGER_H
