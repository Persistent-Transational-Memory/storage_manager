...
#pragma once
#ifndef PTM_LOG_MANAGER_SIMPLE_LOG_MANAGER_DRAM_LOG_MANAGER_H
#define PTM_LOG_MANAGER_SIMPLE_LOG_MANAGER_DRAM_LOG_MANAGER_H
...
#endif //PTM_LOG_MANAGER_SIMPLE_LOG_MANAGER_DRAM_LOG_MANAGER_H
